#!/usr/bin/env python3
"""Local CI aggregation for reviewer-facing behavioral and intervention artifacts."""
...
def parse_args() -> argparse.Namespace:
    ap = argparse.ArgumentParser(description="Aggregate local confidence intervals for reviewer-facing artifacts.")
    ap.add_argument(
        "--four-lang-root",
        type=str,
